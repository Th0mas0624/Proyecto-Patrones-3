...
public class Ball {
    ...
    public void move(int targetX, int targetY) {
        if (!enMovimiento) {
            ...
            velocidadX =(int) (10 * direccionX);  // Ajusta la velocidad según sea necesario
            velocidadY = (int) (10 * direccionY);  // Ajusta la velocidad según sea necesario
